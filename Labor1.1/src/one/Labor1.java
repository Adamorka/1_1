...
public class Labor1 {
    public static void main(String args[]) {
        ...
        System.out.println("Создадим многочлен P");
        List listP = new List(enterSize());
        enterList(listP);
        System.out.println("Создадим многочлен Q");
        ...
        listQ.print();
        System.out.println();
        System.out.println("Equality of P,Q is " + equality(listP, listQ));
        System.out.println("\nНайдем значение многочлена P:");
        System.out.println("Введите значение X");
        while (!scan.hasNextInt())
            scan.nextInt();
        int x = scan.nextInt();
        listP.print();
        System.out.printf("= %d ,где  x = %d\n\n", meaning(listP, x), x);
        System.out.println("Найдем сумму двух многочленов (P,Q):");
        listP.print();
        System.out.println("\n+");
        listQ.print();
        System.out.println("\n=");
